...
const data = extractData("./Q2/G5/133_nodes.edges");
const nodes = data.nodes;
const edges = data.edges;
const property = computerProperty(nodes, edges);
drawDegreeDistributionGraph(nodes, edges, "Q2, Graph 5 - 133 Nodes");
fs.writeFile(
  "./Q2/G5/index.html",
  createHtmlContent(nodes, edges, property, "Q2, Graph 5"),
  (err) => {
    if (err) {
      console.error(err);
      return;
    }
    console.log("./Q2/G5/index.html file created successfully.");
    exec("start ./Q2/G5/index.html", (error) => {
      if (error) {
